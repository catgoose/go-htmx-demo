...
func appNavNavConfig() linkwell.NavConfig {
	return linkwell.NavConfig{
		...
		Items: []linkwell.NavItem{
			...
			{Label: "Patterns", Href: "/patterns", Icon: "M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1", Children: []linkwell.NavItem{
				{Label: "Controls", Href: "/patterns/controls"},
				{Label: "CRUD", Href: "/patterns/crud"},
				{Label: "Lists", Href: "/patterns/lists"},
				{Label: "Interactions", Href: "/patterns/interactions"},
				{Label: "State", Href: "/patterns/state"},
				{Label: "Errors", Href: "/patterns/errors"},
			}},
			{Label: "Components", Href: "/components", Icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10", Children: []linkwell.NavItem{
				{Label: "Widgets", Href: "/components/widgets"},
				{Label: "Cards & Data", Href: "/components/cards"},
				{Label: "Advanced", Href: "/components/advanced"},
			}},
			{Label: "Real-time", Href: "/realtime", Icon: "M13 10V3L4 14h7v7l9-11h-7z", Children: []linkwell.NavItem{
				{Label: "Dashboard", Href: "/realtime/dashboard"},
				{Label: "Feed", Href: "/realtime/feed"},
				{Label: "Canvas", Href: "/realtime/canvas"},
			}},
			{Label: "API", Href: "/api", Icon: "M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z", Children: []linkwell.NavItem{
				{Label: "HAL", Href: "/api/hal"},
				{Label: "Link Relations", Href: "/api/links"},
				{Label: "Web Standards", Href: "/api/standards"},
			}},
			{Label: "Applications", Href: "/apps", Icon: "M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z", Children: []linkwell.NavItem{
				{Label: "Inventory", Href: "/apps/inventory"},
				{Label: "Catalog", Href: "/apps/catalog"},
				{Label: "People", Href: "/apps/people"},
				{Label: "Kanban", Href: "/apps/kanban"},
				{Label: "Approvals", Href: "/apps/approvals"},
				{Label: "Vendors", Href: "/apps/vendors"},
				{Label: "Bulk", Href: "/apps/bulk"},
			}},
			{Label: "Platform", Href: "/platform", Icon: "M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01", Children: []linkwell.NavItem{
				{Label: "Logging", Href: "/platform/logging"},
				{Label: "Repository", Href: "/platform/repository"},
				{Label: "Settings", Href: "/platform/settings"},
				{Label: "PWA Offline", Href: "/platform/pwa"},
			}},
			// setup:feature:demo:end
