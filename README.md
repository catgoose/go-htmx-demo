...
| Components 3                                                                                                  | Interactions                                                                                                       |
| ------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| ![Components 3](https://raw.githubusercontent.com/catgoose/screenshots/main/harmony/components3-viewport.png) | ![Interactions](https://raw.githubusercontent.com/catgoose/screenshots/main/harmony/interactions-viewport.png)      |

| Settings                                                                                                     | Activity Feed                                                                                          |
| ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ |
| ![Settings](https://raw.githubusercontent.com/catgoose/screenshots/main/harmony/settings-viewport.png)       | ![Feed](https://raw.githubusercontent.com/catgoose/screenshots/main/harmony/feed-viewport.png)         |

| Real-time Dashboard                                                                                          | Retrospective Logging                                                                                  |
| ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------ |
| ![Realtime](https://raw.githubusercontent.com/catgoose/screenshots/main/harmony/realtime-viewport.png)       | ![Logging](https://raw.githubusercontent.com/catgoose/screenshots/main/harmony/logging-viewport.png)   |

| Error Traces                                                                                                       |
| ------------------------------------------------------------------------------------------------------------------ |
| ![Error Traces](https://raw.githubusercontent.com/catgoose/screenshots/main/harmony/error-traces-viewport.png)     |
...
- **Context Navigation** -- Full context bar (all rings under your hub), local context bar (immediate siblings), history breadcrumbs (where you've been), hierarchy breadcrumbs (where this page lives). All server-rendered. All dismissable. All driven by the link registry. The server knows where you are. The server has always known where you are. The server finds your lack of `rel="up"` disturbing.
